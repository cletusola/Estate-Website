    ...
    return (
        <React.Fragment>
            ...
            <div className="first">
               ...
               <img className="first-img" src={require('./about.jpg')} alt="about-img" />
            </div>
...
Sed porttitor lectus nibh. Vivamus magna justo, lacinia eget consectetur sed, convallis at tellus. Mauris blandit aliquet elit, eget tincidunt nibh pulvinar a. Vivamus magna justo, lacinia eget consectetur sed, convallis at tellus. </p>
            ...
            <div className="team">
                ...
                <div className="team-1">
                    <img className="team-img" src={require('./agent.jpg')} alt="agent-img"/>
                ...
                <img className="team-img" src={require('./aa.jpg')} alt="agent-img"/>
                ...
                <img className="team-img" src={require('./agent2.jpg')} alt="agent-img"/>
